    ...
    <div style={{ minHeight: "100vh", background: c.canvas, color: c.ink, fontFamily: body, overflow: "hidden", cursor: "none" }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "2rem" }}>
          <Link to="/atelier-plus" onMouseEnter={() => setCursorVariant("play")} onMouseLeave={() => setCursorVariant("default")} style={{ fontFamily: body, fontSize: "0.85rem", fontWeight: 600, color: c.muted, textDecoration: "none" }}>Home</Link>
          <Link to="/atelier-plus/login" onMouseEnter={() => setCursorVariant("play")} onMouseLeave={() => setCursorVariant("default")} style={{ fontFamily: body, fontSize: "0.85rem", fontWeight: 700, color: "#fff", background: c.ink, padding: "0.6rem 1.4rem", borderRadius: "99px", textDecoration: "none" }}>Log in</Link>
        </div>
      </nav>
