...
const BentoItem = ({ s, i, setCursorVariant }: any) => {
        ...
        {studios.map((studio, i) => {
          ...
          return (
            <Float key={studio.name} speed={3 + i * 0.5} rotationIntensity={2} floatIntensity={1} position={[x, y, z]}>
              <NodeGeometry args={i % 3 === 1 ? [0.25, 32, 32] : [0.3]}>
...
export default function AtelierPlusLanding() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: c.canvas, color: c.ink, fontFamily: body, overflow: "hidden", cursor: "none" }}>
      ...
      >
        <Link to="/atelier-plus" onMouseEnter={() => setCursorVariant("play")} onMouseLeave={() => setCursorVariant("default")} style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "0.75rem" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "2.5rem" }}>
          <div style={{ display: "none", gap: "2rem", alignItems: "center" }} className="md-flex">
            <Link to="/atelier-plus" onMouseEnter={() => setCursorVariant("play")} onMouseLeave={() => setCursorVariant("default")} style={{ fontFamily: body, fontSize: "0.85rem", fontWeight: 600, color: c.ink, textDecoration: "none" }}>Home</Link>
            <Link to="/atelier-plus/pricing" onMouseEnter={() => setCursorVariant("play")} onMouseLeave={() => setCursorVariant("default")} style={{ fontFamily: body, fontSize: "0.85rem", fontWeight: 600, color: c.muted, textDecoration: "none", transition: "color 0.2s" }} onFocus={e => e.currentTarget.style.color = c.ink} onBlur={e => e.currentTarget.style.color = c.muted}>Pricing</Link>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
            <Link to="/atelier-plus/login" onMouseEnter={() => setCursorVariant("play")} onMouseLeave={() => setCursorVariant("default")} style={{ fontFamily: body, fontSize: "0.85rem", fontWeight: 600, color: c.ink, textDecoration: "none" }}>Log in</Link>
            <Link
              to="/atelier-plus/login"
      ...
      <section style={{ padding: "8rem 2rem", position: "relative", zIndex: 10 }}>
        <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
          ...
          <motion.div 
            ...
            variants={stagger}
            style={{ display: "grid", gridTemplateColumns: "repeat(12, 1fr)", gap: "1.5rem", autoRows: "minmax(280px, auto)" }}
