    ...
    return (
        <div style={{ minHeight: "100vh", display: "flex", fontFamily: body, background: c.surface, overflow: "hidden" }}>
            ...
            >
                ...
                {/* Logo */}
                <Link to="/atelier-plus" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "0.75rem", position: "relative", zIndex: 10 }}>
            ...
            >
                ...
                <div style={{ position: "absolute", top: "2rem", left: "2rem" }} className="mobile-nav">
                    <Link to="/atelier-plus" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                ...
                >
                    ...
                    <form onSubmit={e => e.preventDefault()} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                        ...
                        <p style={{ textAlign: "center", fontSize: "0.85rem", color: c.muted, marginTop: "1rem" }}>
                            Already have an account? <Link to="/atelier-plus/login" style={{ color: c.primary, fontWeight: 600, textDecoration: "none" }}>Log in</Link>
                        </p>
                    </form>
                </motion.div>
            </div>
