...
import { useOutputPresence } from "../../features/collaboration/presence";
...
export function OutputWorkspacePage() {
  ...
  const collaborators = useOutputPresence(currentProject?.id ?? null, outputId ?? null);
