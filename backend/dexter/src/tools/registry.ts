...
import { exaSearch, WEB_SEARCH_DESCRIPTION, xSearchTool, X_SEARCH_DESCRIPTION } from './search/index.js';
...
const ENABLE_BROWSER_TOOLS = false;
...
export function getToolRegistry(model: string): RegisteredTool[] {
  ...
  // All web search goes through Exa.
