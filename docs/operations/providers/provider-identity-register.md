...
**`cc23700f678173d87e635a8a205dfad80d432e88`**. “Verified” means an
...
| Supabase project | Ref `vffndfwdykxqjlnntuuk`; organization `nwvyypcrdwhzwpurtonm`; URL `https://vffndfwdykxqjlnntuuk.supabase.co` | On 2026-07-12, CLI 2.109.0 `projects list` authenticated and reported Beyond Chat Production `ACTIVE_HEALTHY` and linked; `migration list --linked` showed local=remote for nine migrations `20260711130000` through `20260712013100`, agreeing with MCP identity evidence | CLI/MCP identity verified; promoted migration history agrees through `20260712013100` | Review/apply local-only `20260712013200` through the authorized migration workflow, then recapture agreement; do not imply it is remote before proof |
